...
### Experience
- 2009.02 : 충렬고 졸업
- 2009.03 : 동아대 관광경영과 입학
- 2013.03 : 일본 고베 유통과학대 교환학생
- 2016.02 : 동아대 졸업
- 2019.04 : 프로그래밍 교육 수료
- 2019.08 : 개발 업무 시작!
### Work Experience
...
GMT : {
    기간 : 2019.08 ~,
    프로젝트 :[
        지능형 해양쓰레기 수거지원 모니터링 시스템 연구용역,
        제주 파력 발전 시험장 파주기 챠트 제작,
        해양경찰청 오염방제 시스템 기능개선 및 유지보수,
        해양 통합 네비게이션 프로그램 제작,
        해양환경공단 골재채취선박 및 해양환경 관제시스템 기능개선
        전자조업 감시(보고) 시스템 기능개선 및 유지보수
    ]
}
```
### SKILLS
...
#### Images
<div>
<img src = 'https://user-images.githubusercontent.com/45280952/107639568-62a7a880-6cb4-11eb-9e8a-280a7b61c7f8.png' width = "250px" >
